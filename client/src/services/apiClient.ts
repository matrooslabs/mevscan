...
class ApiClient {
   ...
   */
  async getGrossMEV(timeRange: string = '24hours'): Promise<TimeSeriesResponse> {
    try {
   ...
   * @returns Promise resolving to time series data
   */
  async getGrossAtomicArb(timeRange: string = '24hours'): Promise<TimeSeriesResponse> {
    try {
   ...
   * @returns Promise resolving to time series data
   */
  async getGrossCexDexQuotes(timeRange: string = '24hours'): Promise<TimeSeriesResponse> {
    try {
   ...
   * @returns Promise resolving to time series data
   */
  async getGrossLiquidation(timeRange: string = '24hours'): Promise<TimeSeriesResponse> {
    try {
   ...
   */
  async getAtomicMEVTimeboosted(timeRange: string = '24hours'): Promise<TimeSeriesByProtocolResponse> {
    try {
   ...
   */
  async getExpressLaneMEVPercentage(timeRange: string = '24hours'): Promise<PieChartResponse> {
    try {
   ...
   */
  async getExpressLaneMEVPercentagePerMinute(timeRange: string = '24hours'): Promise<TimeSeriesPercentageResponse> {
    try {
   ...
   * @returns Promise resolving to time series data by protocol
   */
  async getAtomicMEV(timeRange: string = '24hours'): Promise<TimeSeriesByProtocolResponse> {
    try {
   ...
   * @returns Promise resolving to time series data by protocol
   */
  async getCexDex(timeRange: string = '24hours'): Promise<TimeSeriesByProtocolResponse> {
    try {
   ...
   * @returns Promise resolving to time series data by protocol
   */
  async getCexDexTimeboosted(timeRange: string = '24hours'): Promise<TimeSeriesByProtocolResponse> {
    try {
   ...
   * @returns Promise resolving to time series data by protocol
   */
  async getLiquidation(timeRange: string = '24hours'): Promise<TimeSeriesByProtocolResponse> {
    try {
   ...
   * @returns Promise resolving to time series data by protocol
   */
  async getLiquidationTimeboosted(timeRange: string = '24hours'): Promise<TimeSeriesByProtocolResponse> {
    try {
   ...
   */
  async getExpressLaneNetProfit(timeRange: string = '24hours'): Promise<ExpressLaneNetProfitResponse> {
    try {
   ...
   */
  async getExpressLaneProfitByController(timeRange: string = '24hours'): Promise<ExpressLaneProfitByControllerResponse> {
    try {
   ...
   * @returns Promise resolving to Timeboost Revenue data
   */
  async getTimeboostRevenue(timeRange: string = '24hours'): Promise<TimeboostRevenueResponse> {
    try {
   ...
   */
  async getBidsPerAddress(timeRange: string = '24hours'): Promise<BidsPerAddressResponse> {
    try {
   ...
   */
  async getAuctionWinCount(timeRange: string = '24hours'): Promise<AuctionWinCountResponse> {
    try {
   ...
   */
  async getExpressLanePrice(timeRange: string = '24hours'): Promise<ExpressLanePriceResponse> {
    try {
