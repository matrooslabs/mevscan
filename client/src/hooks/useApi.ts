 ...
 * @param timeRange - Optional time range (default: '24hours')
 * @returns Query result with time series data
 */
export function useGrossMEV(timeRange: string = '24hours'): UseQueryResult<TimeSeriesResponse, Error> {
 ...
 * @returns Query result with time series data
 */
export function useGrossAtomicArb(timeRange: string = '24hours'): UseQueryResult<TimeSeriesResponse, Error> {
  return useStaggeredQuery<TimeSeriesResponse>(
 ...
 * @returns Query result with time series data
 */
export function useGrossCexDexQuotes(timeRange: string = '24hours'): UseQueryResult<TimeSeriesResponse, Error> {
  return useStaggeredQuery<TimeSeriesResponse>(
 ...
 * @returns Query result with time series data
 */
export function useGrossLiquidation(timeRange: string = '24hours'): UseQueryResult<TimeSeriesResponse, Error> {
  return useStaggeredQuery<TimeSeriesResponse>(
 ...
 */
export function useAtomicMEVTimeboosted(timeRange: string = '24hours'): UseQueryResult<TimeSeriesByProtocolResponse, Error> {
 ...
 */
export function useExpressLaneMEVPercentage(timeRange: string = '24hours'): UseQueryResult<PieChartResponse, Error> {
 ...
 */
export function useExpressLaneMEVPercentagePerMinute(timeRange: string = '24hours'): UseQueryResult<TimeSeriesPercentageResponse, Error> {
 ...
 * @returns Query result with time series data by protocol
 */
export function useAtomicMEV(timeRange: string = '24hours'): UseQueryResult<TimeSeriesByProtocolResponse, Error> {
  return useStaggeredQuery<TimeSeriesByProtocolResponse>(
 ...
 * @returns Query result with time series data by protocol
 */
export function useCexDex(timeRange: string = '24hours'): UseQueryResult<TimeSeriesByProtocolResponse, Error> {
  return useStaggeredQuery<TimeSeriesByProtocolResponse>(
    ['cexdex', timeRange],
    async () => {
 ...
 * @returns Query result with time series data by protocol
 */
export function useCexDexTimeboosted(timeRange: string = '24hours'): UseQueryResult<TimeSeriesByProtocolResponse, Error> {
  return useStaggeredQuery<TimeSeriesByProtocolResponse>(
 ...
 * @returns Query result with time series data by protocol
 */
export function useLiquidation(timeRange: string = '24hours'): UseQueryResult<TimeSeriesByProtocolResponse, Error> {
  return useStaggeredQuery<TimeSeriesByProtocolResponse>(
 ...
 * @returns Query result with time series data by protocol
 */
export function useLiquidationTimeboosted(timeRange: string = '24hours'): UseQueryResult<TimeSeriesByProtocolResponse, Error> {
  return useStaggeredQuery<TimeSeriesByProtocolResponse>(
 ...
 */
export function useExpressLaneNetProfit(timeRange: string = '24hours'): UseQueryResult<ExpressLaneNetProfitResponse, Error> {
 ...
 */
export function useExpressLaneProfitByController(timeRange: string = '24hours'): UseQueryResult<ExpressLaneProfitByControllerResponse, Error> {
 ...
 * @returns Query result with Timeboost Revenue data
 */
export function useTimeboostRevenue(timeRange: string = '24hours'): UseQueryResult<TimeboostRevenueResponse, Error> {
  return useStaggeredQuery<TimeboostRevenueResponse>(
 ...
 */
export function useBidsPerAddress(timeRange: string = '24hours'): UseQueryResult<BidsPerAddressResponse, Error> {
 ...
 */
export function useAuctionWinCount(timeRange: string = '24hours'): UseQueryResult<AuctionWinCountResponse, Error> {
 ...
 */
export function useExpressLanePrice(timeRange: string = '24hours'): UseQueryResult<ExpressLanePriceResponse, Error> {
